...
class Building_geometry:
    ...
    def geom_building(self):
        ...
        nodes, edges, faces = convert_geom_definition(nodes_floor, edges_floor, self.height)
...
class Shearwall:
    ...
    def geom_shearwall(self):
        ...
        if self.aligned == 'center':
            nodes_floor = [[-(self.top_flange_width / 2) / 1000, h], [0, h], [self.top_flange_width / 1000, h]]
            nodes_floor += [[-(self.bot_flange_width / 2) / 1000, 0], [0, 0], [self.bot_flange_width / 1000, 0]]
            edges_floor = [[0, 1], [1, 2], [3, 4], [1, 4]]
...
def convert_geom_definition(nodes_floor, edges_floor, building_h):
    """
    """
